...
export default async function Index(context) {
    ...
    const user_address = public_users?.address.address;
    const contract_method = "sendMessage";
    ...
    //     args: [16015286601757825753n, "0x269a639D9A8c6c300250BcC4D561EA9d245A5690", ""]
    // });
            ...
            <div className="flex-1 w-full flex flex-col gap-20 items-center">
                <div className="animate-in flex-1 flex flex-col gap-20 opacity-0 max-w-7xl px-3 pt-20">
                    <main className="flex-1 flex flex-col gap-6">
                        <h1 className="mb-5 text-5xl font-bold">Discover Tokenized Goods</h1>
                                ...
                                <div className="card w-96 bg-base-100 shadow-xl">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="card-actions justify-end">
                                            <TxnButton name={contract_method} target_address={user_address} target_chain={target_chain} txn_data="Grape" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="carousel-item">
                                <div className="card w-96 bg-base-100 shadow-xl">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <p>If a dog chews shoes whose shoes does he choose?</p>
                                        <div className="card-actions justify-end">
                                            <TxnButton name={contract_method} target_address={user_address} target_chain={target_chain} txn_data="Lomen" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="carousel-item">
                                <div className="card w-96 bg-base-100 shadow-xl">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <p>If a dog chews shoes whose shoes does he choose?</p>
                                        <div className="card-actions justify-end">
                                            <TxnButton name={contract_method} target_address={user_address} target_chain={target_chain} txn_data="Pineapple" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="carousel-item">
                                <div className="card w-96 bg-base-100 shadow-xl">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <p>If a dog chews shoes whose shoes does he choose?</p>
                                        <div className="card-actions justify-end">
                                            <TxnButton name={contract_method} target_address={user_address} target_chain={target_chain} txn_data="Cherry!" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="carousel-item">
                                <div className="card w-96 bg-base-100 shadow-xl">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <p>If a dog chews shoes whose shoes does he choose?</p>
                                        <div className="card-actions justify-end">
                                            <TxnButton name={contract_method} target_address={user_address} target_chain={target_chain} txn_data="Strawberry!" />
                                        </div>
                                    </div>
                                </div>
                            </div>
